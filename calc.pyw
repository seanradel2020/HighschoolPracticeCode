...
class Calculator:
    ...
    def __createButtons(self):
        ...
        #start with all the standard sized __createButtons
    ...
    def getButton(self):
        #Waits for a button to be clicked and rethr s the label
        while True:
            p = self.win.getMouse()
            for b in self.buttons:
                if b.clicked(p):
    ...
    def processButton(self, key):
        ...
        if key == 'C':
            ...
            #the try except mechanism "catches" erros in the formuoili being evalulated
            try:
                result = eval(text)
            except:
                result = 'ERROR'
